...
_MARKET = (0.0898, "S&P 500 50-yr avg (test)")


def test_analyse_rental_returns_30_years():
    result = analyse_rental(FakeProp(), db=None, _test_market=_MARKET)
...
def test_break_even_fires_mid_horizon():
    ...
    result = analyse_rental(FakeBreakEvenProp(), db=None, _test_market=_MARKET)
